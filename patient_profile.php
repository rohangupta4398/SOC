...
<script type="text/javascript">
 ...
 function fd_show_list()
  ...
  <!-------------------------BLOOD SUGAR MONITORING--------------------->   
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"  style="position:relative;left:10%;width:810px;height:400px;" id=blood_sugar><br>
        ...
        <hr class="w3-clear">
        <form action="blood_sugar.php" method="get" style="font-size: 150%">
          <br>
          <center>
 ...
 <!------------------------------UPLOAD REPORTS----------------------------->
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"  style="position:relative;left:10%;width:810px;height:450px;" id="upload_reports"><br>
        <img src="sugar_lvl.jpg" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="vertical-align: middle;border-radius:0%;width:50px">
        <h2 align="center">UPLOAD REPORTS</h2>
        <hr class="w3-clear">
        <form action="upload.php?"= method="post" enctype="multipart/form-data" style="font-size: 150%;">
          <center>
           SELECT REPORT TO BE UPLOADED : &nbsp
           <input type="file" name="UploadFileField" id="fileToUpload" style="width:15%"><br><BR>
           DATE OF REPORT:<input type="text" name="year" id="year" style="width:9%;text-align: center;border-radius: 5px"> / 
           <input type="text" name="day" id="day" style="width:5%;text-align: center;border-radius: 5px"> / 
           <input type="text" name="day" id="day" style="width:5%;text-align: center;border-radius: 5px"><br><br>
           TEST NAME:<input type="text" name="test_name" id="test_name"><br><br>
           <input type="submit" value="UPLOAD REPORT" name="submit" id="s4" style="height:60px;width:25%;font-size: 90%">
          </center>
        </form>
        <br><br><br> <br>
      </div>
