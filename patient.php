...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:60px">    
 ...
 <!------------------------------------- Profile of patient------------------------------------------>
      ...
      <div class="w3-card w3-round w3-white" style="left:20px;top:70px;width:19%;position:fixed" type>
       ...
       <a href="#blood_sugar">
          <button  style="position: fixed;top: 550px;left: 20px;height:60px;width: 19%;font-size: 22px">BLOOD SUGAR</button> 
      </a> 
       <a href="#find_a_doc">
          <button  style="position: fixed;top: 620px;left: 20px;height:60px;width: 19%;font-size: 22px">FIND A DOC</button> 
      </a>
      <a href="#">
          <button  style="position: fixed;top: 690px;left: 20px;height:60px;width: 19%;font-size: 22px">UPLOAD PREVIOUS REPORTS</button> 
      </a>
      <a href="#">
          <button  style="position: fixed;top: 760px;left: 20px;height:60px;width: 19%;font-size: 22px">MEDORA</button>
      </a>
      <br>
...
{    
        ...
        var sy=getElementById('sy').value;
        var sm=getElementById('sm').value;
        var sd=getElementById('sd').value;
        var ey=getElementById('ey').value;
        var em=getElementById('em').value;
        var ed=getElementById('ed').value;
        xmlhttp.open("GET","his.php?start_date="+sy+"-"+sm+"-"+sd+"&end_date="+ey+"-"+em+"-"+ed+"&disease="+getElementById('disease').value,true);
        xmlhttp.send();
...
?>           
  ...
  <!-------------------------BLOOD SUGAR MONITORING--------------------->   
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"  style="position:relative;left:-225px;width:810px;height:400px;" id=blood_sugar><br>
  ...
  <!---------------------FIND A DOC---------------->
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"  style="position:relative;left:-225px;width:810px;height: 400px" id="find_a_doc"><br>
        <img src="find_doc.png" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="vertical-align: middle;border-radius:0%;width:50px">
        <h2 align="center">FIND A DOC</h2>
        <hr class="w3-clear">
        <form action="add_current.php" method="get" style="font-size: 18px">
          <br>
          <center>
