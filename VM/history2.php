...
$sql="SELECT DISTINCT Diagnosis FROM A_".$_SESSION['a'];
$result=$conn->query($sql);
 ...
 function history_show_list()
    {
      if (window.XMLHttpRequest) {
        ...
        xmlhttp.open("POST","history_show_list.php?sdate="+document.getElementById('sy').value+"-"+document.getElementById('sm').value+"-"+document.getElementById('sd').value+"&edate="+document.getElementById('ey').value+"-"+document.getElementById('em').value+"-"+document.getElementById('ed').value+"&doctor="+document.getElementById('disease').value,true);
      xmlhttp.send(); 
    }
</script>
<center>
