...
if($diagnosis!='' && $sdate=='--')
{
  ...
  $sql="SELECT * FROM A_".$_SESSION['a']." WHERE Diagnosis='".$diagnosis."'";
...
$sql="SELECT * FROM A_".$_SESSION['a']." WHERE Date >= '".$sdate."' and Date <= '".$edate."' and Diagnosis='".$diagnosis."'";
$result=$conn->query($sql);
...
$sql="SELECT * FROM A_".$_SESSION['a']." WHERE Date >= '".$sdate."' and Date <= '".$edate."'";
$result=$conn->query($sql);
