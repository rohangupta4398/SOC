...
<script>
  $(document).ready(function(){
      <?php 
        ...
        $sql = "SELECT * FROM questions where Question LIKE '%".$a."%'   AND Category='".$_SESSION['Category']."' ";
        $result = mysqli_query($conn, $sql);
...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m9">
      ...
      <?php
          $conn = mysqli_connect("localhost","root","sarthak2007","SOC");
          $sql = "SELECT * FROM questions where Question LIKE '%".$a."%' AND Category='".$_SESSION['Category']."' order by Sno desc";
          $result = mysqli_query($conn, $sql);
          //$q=mysqli_num_rows($result);
          $countq=0;
          if(mysqli_num_rows($result)>0){
            while($row = mysqli_fetch_assoc($result)) {
              ...
              echo "<input type='text' name='sno' value='".$row['Sno']."' style='display:none;'>
