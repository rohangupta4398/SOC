      ...
      <div style='background-color:  rgba(255, 255, 255, 0.65);color:black' class="w3-container w3-card w3-round w3-margin" id="curnt"><br>
        ...
        <form action="ven1.php" method="post">
          ...
          <center>
            ...
            ENTER DATE OF PRESCRITION: <input type="text" name='date_doctor' required><!----------------change------------------------------->
...
<div style='background-color:  rgba(255, 255, 255, 0.65);color:black' class="w3-container w3-card w3-round w3-margin"><br>
        ...
        <form action="upl.php" method="post" enctype="multipart/form-data">
          ...
          <center>
            ...
            ENTER DATE : <input type="text" id='dd' name="dd" required placeholder="DD"> / <input type="text" id='mm' name="mm" required placeholder="MM"> /<input type="text" id='yy' name="yy" required placeholder="YYYY"> 
            ...
            <p id="show_test_types"><input type="button" value="SHOW TESTS" onclick="show_test_list"></p>
...
function show_test_list() {
  ...
  xmlhttp.onreadystatechange=function() {
    if (this.readyState==4 && this.status==200) {
      document.getElementById("show_test_list").innerHTML=this.responseText;
    }
  }
  xmlhttp.open("POST","show_test_list.php?=date"+getElementById('yy').value+"-"+getElementById('mm').value+"-"+getElementById('dd').value+"&aadhar_no"=getElementById('aadhar_no').value,true);
  xmlhttp.send();
} 
</script>
