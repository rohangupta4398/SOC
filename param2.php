...
<!--------------------------------------------------------------------------DIVISIONS FOR MAIN PART----------------------------------------------------------------------------------->
  ...
  <!-------------------------REFER IT TO ANOTHER DOCTOR--------------------->   
      ...
      <div class="w3-container w3-card w3-round w3-margin"  style="position:relative;left:-10%;width:80%;top:20%;;background-color:  rgba(255, 255, 255, 0.65);color:black" id="refer"><br>
        ...
        <hr class="w3-clear">
        <form method='POST' action='refered.php' style="font-size: 130%">
<center>

STATE:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<select name='state' id='state' onchange="showcity()" style="width:40%">
...
function show_docs() {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("showdocs_p").style.display='block';
...
<select name="city" id='city' onchange="showspeciality()" style="width:40%">
...
<p id='speciality_p'>
  SPECIALITY:
  <select name="speciality" id='speciality' style="width:40%">
    <option value="">Select Severity</option>
  </select>
</p>


<input type="button" class="w3-button  w3-margin-bottom" value="SHOW DOCTORS" style="background-color:#4CAF50;border: none;color: white;padding: 10px 32px;text-align: center;text-decoration: none;position:relative;margin-top:%;border-radius:20px;font-size:20px;" onclick="show_docs()">
<p id="showdocs_p" style="display: none;"> 
</p>

          <br><br>
          COMMENTS: <input type="text" id='2' name="comments"><br>
          <button type="submit" class="w3-button  w3-margin-bottom" style="background-color:#4CAF50;border: none;color: white;padding: 10px 32px;text-align: center;text-decoration: none;position:relative;margin-top:7%;border-radius:20px;font-size:20px;" id="s1"><i class="fa fa-send-o" ></i>Submit</button>
          <br><br>
         </center>
        </form>
      </div>
