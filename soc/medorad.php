...
<script>
  $(document).ready(function(){
      <?php 
        ...
        mysqli_close($conn);
      ?>
      for(var i=1;i<=<?php echo $a; ?>;i+=2){
        $("#"+i).click(function(){
            //document.write(i);
             $(this).nextUntil("input[type='text']").slideToggle(1000);
        });
      }
      for(var i=2;i<=<?php echo $b; ?>;i+=2){
        $("#"+i).click(function(){
 ...
 <div class="w3-bar w3-theme-d5 w3-left-align w3-large" style="background-color:black">
  ...
  <div class="w3-dropdown-hover w3-hide-small w3-theme-d5">
    <?php
        ...
        $sql = "SELECT * FROM questions where LIC='".$_SESSION['LicenseID']."'";
        $result = mysqli_query($conn, $sql);
  ...
  <a href="questiond.php" class="w3-bar-item w3-hover-white w3-button w3-padding-large w3-theme-d5"><i class="fa fa-plus w3-margin-right"></i>ASK A QUESTION</a>
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round" style="position:fixed;width: 20%;left: 4.35%;top:8%;background-color:  rgba(255, 255, 255, 0.65);color:black">
        <div class="w3-container">
         ...
         <hr>
          <p style='text-color: #666666;font-size:18px'>&nbsp&nbsp&nbsp<i class='fa fa-pencil' style='font-size:28px;color: #666666'></i>&nbsp&nbsp<b>Name:</b>&nbsp&nbsp<?php echo $row["Name"]; ?></p>
         <p style='text-color: #666666;font-size:18px'>&nbsp&nbsp&nbsp<i class='fa fa-venus-mars ' style='font-size:28px;color: #666666'></i><strong>&nbsp&nbspSex: </strong>&nbsp&nbsp<?php echo $row["Gender"]; ?> </p>
         <p style='text-color: #666666;font-size:18px'>&nbsp&nbsp&nbsp<i class='fa fa-user-md' style='font-size:28px;color: #666666'></i>&nbsp&nbsp<b>Specialist:</b>&nbsp&nbsp<?php echo $row["Specialist"]; ?> </p>
        </div>
      </div>
      <br>
    </div>
    ...
    <div class="w3-col m9">
      ...
      <?php
          ...
          while($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<input type='text' name='sno' value='".$row['Sno']."' style='display:none;'><input type='text' name='a' value='2' style='display:none;'>
  ...
  function f(cat){
    ...
    xml.onreadystatechange=function(){
      ...
      if(this.readyState==4 && this.status==200){
          ...
          window.top.location.href = "Categoryd.php";
  ...
  function g(a,b){
    ...
    xml.onreadystatechange=function(){
      ...
      if(this.readyState==4 && this.status==200){
          ...
          window.top.location.href = "Notid.php";
